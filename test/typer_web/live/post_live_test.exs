defmodule TyperWeb.PostLiveTest do
  use TyperWeb.ConnCase

  import Phoenix.LiveViewTest
  import Typer.BlogFixtures

  @create_attrs %{title: "some title", content: "some content", published_at: "2024-09-17"}
  @update_attrs %{title: "some updated title", content: "some updated content", published_at: "2024-09-18"}
